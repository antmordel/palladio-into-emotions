...
public class AComponent
	...
	// contained InternalActions: [compute, computeMore] ([_rl6MwCHbEd62GabW1zGSBw, _0eyYUCHjEd6ZSMvOJK-6LQ])
 ...
 ctx, 
	...
	if (sum_tfAiwCHjEd6ZSMvOJK__6LQ <= u_tfAiwCHjEd6ZSMvOJK__6LQ && u_tfAiwCHjEd6ZSMvOJK__6LQ < sum_tfAiwCHjEd6ZSMvOJK__6LQ + 0.3 )
	{
	...
	sum_tfAiwCHjEd6ZSMvOJK__6LQ += 0.3;
...
/* InternalAction - START */
    ...
    {
      double demand = de.uka.ipd.sdq.simucomframework.variables.converter.NumberConverter.toDouble(ctx.evaluate("Exp(2)",Double.class));
      ctx.findResource(this.assemblyContextID).loadActiveResource(ctx.getThread(),"CPU",demand);
    }
