...
public class AComponent
	...
	// contained InternalActions: [compute] ([_OXyrAKJcEeS1vvyFpccg9g])
...

   {
	...
	action_Fh8EoKJcEeS1vvyFpccg9g(ctx, resultStackFrame, methodBodyStackFrame);
 ...
 ctx, 
	...
	private void action_Fh8EoKJcEeS1vvyFpccg9g(
			final 
	de.uka.ipd.sdq.simucomframework.Context
 ctx, 
			final de.uka.ipd.sdq.simucomframework.variables.stackframe.SimulatedStackframe<Object> resultStackFrame, 
			final de.uka.ipd.sdq.simucomframework.variables.stackframe.SimulatedStackframe<Object> methodBodyStackFrame) {
		// EntityName = componentLoop, Type = pcm__seff__LoopAction
	   
	
   for (int iterationCount_Fh8EoKJcEeS1vvyFpccg9g = 0, maxIterationCount_Fh8EoKJcEeS1vvyFpccg9g = (Integer)ctx.evaluate("IntPMF[(1 ; 0.75) (2 ; 0.25)]",Integer.class);
            iterationCount_Fh8EoKJcEeS1vvyFpccg9g < maxIterationCount_Fh8EoKJcEeS1vvyFpccg9g; iterationCount_Fh8EoKJcEeS1vvyFpccg9g++){
       
	action_Fh950aJcEeS1vvyFpccg9g(ctx, resultStackFrame, methodBodyStackFrame);
   
      
	action_OXyrAKJcEeS1vvyFpccg9g(ctx, resultStackFrame, methodBodyStackFrame);
   
      
	action_Fh950qJcEeS1vvyFpccg9g(ctx, resultStackFrame, methodBodyStackFrame);
	...
	private void action_Fh950aJcEeS1vvyFpccg9g(
			final 
	de.uka.ipd.sdq.simucomframework.Context
 ctx, 
			final de.uka.ipd.sdq.simucomframework.variables.stackframe.SimulatedStackframe<Object> resultStackFrame, 
	...
	private void action_OXyrAKJcEeS1vvyFpccg9g(
			final 
	de.uka.ipd.sdq.simucomframework.Context
 ctx, 
			final de.uka.ipd.sdq.simucomframework.variables.stackframe.SimulatedStackframe<Object> resultStackFrame, 
...
/* InternalAction - START */
    ...
    {
      double demand = de.uka.ipd.sdq.simucomframework.variables.converter.NumberConverter.toDouble(ctx.evaluate("doA.VALUE",Double.class));
...
/* InternalAction - END */
	...
	private void action_Fh950qJcEeS1vvyFpccg9g(
			final 
	de.uka.ipd.sdq.simucomframework.Context
 ctx, 
			final de.uka.ipd.sdq.simucomframework.variables.stackframe.SimulatedStackframe<Object> resultStackFrame, 
