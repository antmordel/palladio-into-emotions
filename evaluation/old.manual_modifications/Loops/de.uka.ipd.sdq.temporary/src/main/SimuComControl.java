	...
	getModel().getProbeSpecContext().getCalculatorRegistry().registerCalculator(
		...
		// Setup calculator for system call aName (_S2zw0KJYEeS1vvyFpccg9g)
		
	getModel().getProbeSpecContext().getCalculatorRegistry().registerCalculator(
			"Call_do0 <EntryLevelSystemCall id: _S2zw0KJYEeS1vvyFpccg9g >", getModel().getProbeSpecContext().getCalculatorFactory().buildResponseTimeCalculator(
					"Call_do0 <EntryLevelSystemCall id: _S2zw0KJYEeS1vvyFpccg9g >", 
					getModel().getProbeSpecContext().obtainProbeSetId("startCall_do0 <EntryLevelSystemCall id: _S2zw0KJYEeS1vvyFpccg9g >"),
					getModel().getProbeSpecContext().obtainProbeSetId("endCall_do0 <EntryLevelSystemCall id: _S2zw0KJYEeS1vvyFpccg9g >")));
